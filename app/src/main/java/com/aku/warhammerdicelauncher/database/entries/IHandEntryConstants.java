...
public interface IHandEntryConstants extends BaseColumns {
    ...
    String COLUMN_NAME_EXPERTISE = "expertise";
    String COLUMN_NAME_FORTUNE = "fortune";
    String COLUMN_NAME_MISFORTUNE = "misfortune";
    String COLUMN_NAME_CHALLENGE = "challenge";
